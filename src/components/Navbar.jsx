...
const Navbar = ({ aboutRef, projectsRef, contactRef }) => {
  ...
  return (
    <div className="my-[18px] fixed w-full z-50 px-6">
      <div className="max-w-[613px] mx-auto flex justify-between items-center py-3 mob:py-0 pl-[26px] pr-4 bg-[#8C8C8C29] rounded-full backdrop-blur-md">
        <div>
        ...
        <div className="hidden sm:block">
          <ul className="flex">
            <li
              ...
              className="px-4 py-3 text-[#FFFFFFB2] cursor-pointer"
            >
              About
            </li>
            <li
