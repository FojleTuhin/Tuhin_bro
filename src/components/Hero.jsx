...
const Hero = () => {
  return (
    <div>
      <div className="max-w-[1320px] mx-auto pt-[128px] pb-24 min-h-screen border-b px-6">
        <div className="grid grid-cols-2">
          <div className="bg-[url('https://i.ibb.co.com/rf5Q8szP/tuhin.png')] h-[500px] bg-no-repeat bg-contain w-full ml-10">
            <div className="flex justify-end flex-col h-[500px] ml-5">
              <p className="text-[24px] mb-3 leading-none">This is,</p>
              <p className="text-[130px] leading-none">Tuhin</p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center gap-8 ">
            <div>
              ...
              <p className="text-[58px] font-medium uppercase leading-none">
